 ...
 * including the number of producers, number of consumers, consumer type, messages per producer,
...
public class BenchmarkConfig {
     ...
     */
    public BenchmarkConfig(int numProducers, int numConsumers, ConsumerType consumerType, int numMessagesPerProducer, int payloadSize, int numRuns) {
     ...
     *   <li>{@code --consumerType}: Type of consumer - HEAVY or LIGHTWEIGHT (default: HEAVY)</li>
    ...
    public static BenchmarkConfig parse(String[] args) {
        ...
        return new BenchmarkConfig(numProducers, numConsumers, consumerType, numMessagesPerProducer, payloadSize, numRuns);
    }
